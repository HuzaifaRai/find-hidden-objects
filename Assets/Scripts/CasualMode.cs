...
public class CasualMode : MonoBehaviour
{
    ...
    public Sprite[] BraceletIonsSprites;
    ...
    private void SetInitialValues()
    {
        ...
        SetupItemData(SaveData.Instance.casualProps.eyesLocked, eyeList);
        ...
        SetupItemData(SaveData.Instance.casualProps.braceletLocked, BraceletList);
        SetItemIcon(BraceletList, BraceletIonsSprites);
        #endregion
        ...
        SetupItemData(SaveData.Instance.casualProps.eyerowsLocked, EyeBrowsList);
        ...
        SetupItemData(SaveData.Instance.casualProps.earringLocked, EarringList);
        ...
        SetupItemData(SaveData.Instance.casualProps.bGLocked, bGList);
    ...
    public void SelectedCategory(int index)
    {
        ...
        else if (index == (int)CasualSelectedItem.BG)
        {
            selectedItem = CasualSelectedItem.BG;
        ...
        else if (index == (int)CasualSelectedItem.Eye)
        {
            selectedItem = CasualSelectedItem.Eye;
        ...
        else if (index == (int)CasualSelectedItem.EyeBrows)
        {
            selectedItem = CasualSelectedItem.EyeBrows;
            uIElements.EyeBrowsScroller.SetActive(true);
            CharactorMover.Move(new Vector3(MakeUpPos.x, MakeUpPos.y, MakeUpPos.z), 0.5f, true, false);

        }
        else if (index == (int)CasualSelectedItem.Bracelet)
        {
            selectedItem = CasualSelectedItem.Bracelet;
            uIElements.BraceletScroller.SetActive(true);
            CharactorMover.Move(new Vector3(DressUpPos.x, DressUpPos.y, DressUpPos.z), 0.5f, true, false);
        }
        else if (index == (int)CasualSelectedItem.Earring)
        {
            selectedItem = CasualSelectedItem.Earring;
    ...
    private void GetItemsInfo()
    {
        ...
        else if (selectedItem == CasualSelectedItem.Eye)
        {
        ...
        else if (selectedItem == CasualSelectedItem.Bracelet)
        {
            SetItemsInfo(BraceletList, BraceletScore);
        }
        else if (selectedItem == CasualSelectedItem.EyeBrows)
        {
            SetItemsInfo(EyeBrowsList, EyeBrowsScore);
        }
        else if (selectedItem == CasualSelectedItem.Earring)
        {
        ...
        else if (selectedItem == CasualSelectedItem.BG)
        {
    ...
    public void UnlockSingleItem()
    {
        ...
        {
            SaveData.Instance.casualProps.eyesLocked[selectedIndex] = false;
        }
        else if (selectedItem == CasualSelectedItem.Blush)
        {
        ...
        {
            SaveData.Instance.casualProps.braceletLocked[selectedIndex] = false;
        }
        else if (selectedItem == CasualSelectedItem.EyeBrows)
        {
            SaveData.Instance.casualProps.eyerowsLocked[selectedIndex] = false;
        }
        else if (selectedItem == CasualSelectedItem.Earring)
        {
