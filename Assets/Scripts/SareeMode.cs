...
[System.Serializable]
public enum SareeSelectedItem
{
    Dress, Hair, Blush, EyeBrows, Eye, LipStick, NeckLace, Earring, Bracelet, Bag, Shoes, BG,
}
public class SareeMode : MonoBehaviour
{
    public SareeSelectedItem selectedItem;
    public SareeUiElements uIElements;
    public SareeOpponent oppElements;
    [Header("PlayerInfo")]
    ...
    private void Start()
    {
        ...
        selectedItem = SareeSelectedItem.Dress;
    ...
    private void SetInitialValues()
    {
        ...
        SetupItemData(SaveData.Instance.sareeProps.dressLocked, dressList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.hairLocked, hairList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.lipStickLocked, lipstickList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.eyesLocked, eyeList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.blushLocked, blushList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.necklaceLocked, necklaceList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.bagLocked, BagList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.braceletLocked, BraceletList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.eyerowsLocked, EyeBrowsList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.earringLocked, EarringList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.shoesLocked, shoesList);
        ...
        SetupItemData(SaveData.Instance.sareeProps.bGLocked, bGList);
    ...
    public void SelectedCategory(int index)
    {
        ...
        if (index == (int)SareeSelectedItem.Dress)
        {
            selectedItem = SareeSelectedItem.Dress;
            uIElements.dressScroller.SetActive(true);
            CharactorMover.Move(new Vector3(DressUpPos.x,DressUpPos.y,DressUpPos.z), 0.5f, true, false);
        }
        else if (index == (int)SareeSelectedItem.Hair)
        {
            selectedItem = SareeSelectedItem.Hair;
        ...
        else if (index == (int)SareeSelectedItem.Bag)
        {
            selectedItem = SareeSelectedItem.Bag;
            uIElements.BagScroller.SetActive(true);
            CharactorMover.Move(new Vector3(DressUpPos.x,DressUpPos.y,DressUpPos.z), 0.5f, true, false);

        }
        else if (index == (int)SareeSelectedItem.Shoes)
        {
            selectedItem = SareeSelectedItem.Shoes;
            uIElements.shoeScroller.SetActive(true);
            CharactorMover.Move(new Vector3(DressUpPos.x,DressUpPos.y,DressUpPos.z), 0.5f, true, false);
        }
        else if (index == (int)SareeSelectedItem.BG)
        {
            selectedItem = SareeSelectedItem.BG;
            uIElements.bGScroller.SetActive(true);
            CharactorMover.Move(new Vector3(DressUpPos.x,DressUpPos.y,DressUpPos.z), 0.5f, true, false);

        }
        else if (index == (int)SareeSelectedItem.Blush)
        {
            selectedItem = SareeSelectedItem.Blush;
            uIElements.blushScroller.SetActive(true);
            CharactorMover.Move(new Vector3(MakeUpPos.x, MakeUpPos.y, MakeUpPos.z), 0.5f, true, false);
        }
        else if (index == (int)SareeSelectedItem.Eye)
        {
            selectedItem = SareeSelectedItem.Eye;
            uIElements.eyeScroller.SetActive(true);
            CharactorMover.Move(new Vector3(MakeUpPos.x, MakeUpPos.y, MakeUpPos.z), 0.5f, true, false);
        }
        else if (index == (int)SareeSelectedItem.LipStick)
        {
            selectedItem = SareeSelectedItem.LipStick;
            uIElements.lipstickScroller.SetActive(true);
            CharactorMover.Move(new Vector3(MakeUpPos.x, MakeUpPos.y, MakeUpPos.z), 0.5f, true, false);
        }
        else if (index == (int)SareeSelectedItem.NeckLace)
        {
            selectedItem = SareeSelectedItem.NeckLace;
            uIElements.necklaceScroller.SetActive(true);
            CharactorMover.Move(new Vector3(MakeUpPos.x, MakeUpPos.y, MakeUpPos.z), 0.5f, true, false);

        }
        else if (index == (int)SareeSelectedItem.EyeBrows)
        {
            selectedItem = SareeSelectedItem.EyeBrows;
            uIElements.EyeBrowsScroller.SetActive(true);
            CharactorMover.Move(new Vector3(MakeUpPos.x, MakeUpPos.y, MakeUpPos.z), 0.5f, true, false);

        }
        else if (index == (int)SareeSelectedItem.Bracelet)
        {
            selectedItem = SareeSelectedItem.Bracelet;
            uIElements.BraceletScroller.SetActive(true);
            CharactorMover.Move(new Vector3(DressUpPos.x, DressUpPos.y, DressUpPos.z), 0.5f, true, false);
        }
        else if (index == (int)SareeSelectedItem.Earring)
        {
            selectedItem = SareeSelectedItem.Earring;
    ...
    {
        if (selectedItem == SareeSelectedItem.Dress)
        {
            SetItemsInfo(dressList, DressScore);
        }
        else if (selectedItem == SareeSelectedItem.Hair)
        {
            SetItemsInfo(hairList, HairScore);
        }
        else if (selectedItem == SareeSelectedItem.LipStick)
        {
            SetItemsInfo(lipstickList, LipstickScore);
        }
        else if (selectedItem == SareeSelectedItem.Eye)
        {
            SetItemsInfo(eyeList, EyeScore);
        }
        else if (selectedItem == SareeSelectedItem.Blush)
        {
            SetItemsInfo(blushList, BlushScore);
        }
        else if (selectedItem == SareeSelectedItem.NeckLace)
        {
            SetItemsInfo(necklaceList, NeckLaceScore);
        }
        else if (selectedItem == SareeSelectedItem.Bag)
        {
            SetItemsInfo(BagList, BagScore);
        }
        else if (selectedItem == SareeSelectedItem.Bracelet)
        {
            SetItemsInfo(BraceletList, BraceletScore);
        }
        else if (selectedItem == SareeSelectedItem.EyeBrows)
        {
            SetItemsInfo(EyeBrowsList, EyeBrowsScore);
        }
        else if (selectedItem == SareeSelectedItem.Earring)
        {
            SetItemsInfo(EarringList, EarringScore);
        }
        else if (selectedItem == SareeSelectedItem.Shoes)
        {
            SetItemsInfo(shoesList, ShoesScore);
        }
        else if (selectedItem == SareeSelectedItem.BG)
        {
    ...
    public void UnlockSingleItem()
    {
        if (selectedItem == SareeSelectedItem.Dress)
        {
            SaveData.Instance.sareeProps.dressLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.Hair)
        {
            SaveData.Instance.sareeProps.hairLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.LipStick)
        {
            SaveData.Instance.sareeProps.lipStickLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.Eye)
        {
            SaveData.Instance.sareeProps.eyesLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.Blush)
        {
            SaveData.Instance.sareeProps.blushLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.NeckLace)
        {
            SaveData.Instance.sareeProps.necklaceLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.Bag)
        {
            SaveData.Instance.sareeProps.bagLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.Bracelet)
        {
            SaveData.Instance.sareeProps.braceletLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.EyeBrows)
        {
            SaveData.Instance.sareeProps.eyerowsLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.Earring)
        {
            SaveData.Instance.sareeProps.earringLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.Shoes)
        {
            SaveData.Instance.sareeProps.shoesLocked[selectedIndex] = false;
        }
        else if (selectedItem == SareeSelectedItem.BG)
        {
            SaveData.Instance.sareeProps.bGLocked[selectedIndex] = false;
        }
        Rai_SaveLoad.SaveProgress();
    }
    #endregion
